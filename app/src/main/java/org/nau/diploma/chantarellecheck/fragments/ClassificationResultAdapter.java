...
import rg.nau.diploma.chantarellecheck.databinding.ItemClassificationResultBinding;
...
public class ClassificationResultAdapter
    ...
    public void updateResults(List<Category> categories) {
        ...
        Collections.sort(sortedCategories, (category1, category2) -> category1.getIndex() - category2.getIndex());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Category category) {
            if (category != null) {
                ...
                tvScore.setText(String.format(Locale.US, "%.2f", 100 * category.getScore()));
            } else {
