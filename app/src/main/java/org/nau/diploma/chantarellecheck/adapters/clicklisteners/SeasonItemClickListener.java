...
public class SeasonItemClickListener implements ArticleRecycleViewAdapter.ItemClickListener {
    ArticleRecycleViewAdapter adapter;
    public SeasonItemClickListener(ArticleRecycleViewAdapter adapter) {
